...
namespace BubblingRT
{
    /// <summary>
    /// A basic page that provides characteristics common to most applications.
    /// </summary>
    public sealed partial class PhotoEdit : BubblingRT.Common.LayoutAwarePage
    {
        public PhotoEdit()
        {
        ...
        public static StorageFile PassedArgument { get; set; }
        ...
        private void Image1_OnManipulationCompleted(object sender, ManipulationCompletedEventArgs e)
        {
            ...
            else
            {
                ...
                currentPolygon.Tapped += (o, args) => { args.Handled = true; };
